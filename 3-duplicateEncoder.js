/* 
The goal of this exercise is to convert a string to a new string where each character i
n the new string is "(" if that character appears only once in the original string, or ")" 
...
function duplicateEncode(word) {
  ...
  return word
    .split("")
    .map((char) => (charCount[char.toLowerCase()] > 1 ? ")" : "("))
    .join("");
}

console.log(duplicateEncode("fahar"));
